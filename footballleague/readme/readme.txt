Football League table generator has has been done through the implementation of an interface which provides different methods to work with data from Matchs.
